...
<body class="bg-gray-100 space-y-5">
    ...
    <div class="py-4 px-10 bg-gray-800 space-x-2">
        <a href="/" class="py-2 px-5 bg-gray-400 rounded-xl hover:bg-gray-500 text-xl
        @if(\Request::path() == '/') bg-gray-500 @endif ">home</a>
        <a href="{{ route('tasks.index')}}" class="py-2 px-5 bg-gray-400 rounded-xl hover:bg-gray-500 text-xl
        @if(\Request::routeIs('tasks.*')) bg-gray-500 @endif ">tasks</a>
        <a href="{{ route('tags.index')}}" class="py-2 px-5 bg-gray-400 rounded-xl hover:bg-gray-500 text-xl

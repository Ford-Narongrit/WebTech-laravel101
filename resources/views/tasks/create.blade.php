...
@section('content')
    ...
    <form action="{{ route('tasks.store') }}" method="POST" class="space-y-3">
        ...
        <div class="text-xl space-y-2">
            ...
            <input type="text" name="title" class="w-full px-4 py-3 rounded-xl border" placeholder="Task title"
                autocomplete="off">
        </div>
        <div class="text-xl space-y-2">
        ...
        <div class="text-xl space-y-2">
            ...
            <input type="date" name="due_date" class="px-4 py-3 rounded-xl border" placeholder="detail" autocomplete="off">
        </div>

        <div class="text-xl space-y-2">
            <label for="tags" class="text-2xl block">Task Tags (separated with comma)</label>
            <input type="text" name="tags" class="w-full px-4 py-3 rounded-xl border" autocomplete="off"
                placeholder="tags">
        </div>

...
<form action="{{ route('tasks.store') }}" method="POST" class="space-y-3">
    ...
    <div class="text-xl space-y-2">
        ...
        <input type="text" name="title" class="w-full px-2 py-3 rounded-xl border" placeholder="Task title" autocomplete="off">
    </div>
    <div class="text-xl space-y-2">
        <label for="detail" class="text-2xl">Detail</label>
        <textarea type="text" name="detail" rows="4" cols="50" class="w-full px-2 py-3 rounded-xl border" placeholder="detail" autocomplete="off"></textarea>
    </div>
    <div class="text-xl space-y-2">
    ...
    <div class="text-xl space-y-2">
        ...
        <input type="text" name="tags" class="w-full px-2 py-3 rounded-xl border" autocomplete="off" placeholder="detail">
    </div>

...
@section('content')
    ...
    <form action="{{ route('tasks.update', ['task' => $task->id]) }}" method="POST" class="space-y-3">
        ...
        <div class="text-xl space-y-2">
            ...
            <input type="text" name="title" class="w-full px-2 py-3 rounded-xl border" value="{{ $task->title }}"
        ...
        <div class="text-xl space-y-2">
            ...
            <input type="date" name="due_date" class="px-2 py-3 rounded-xl border"
        ...
        <div class="text-xl space-y-2">
            ...
            <input type="text" name="tags" value="{{ $task->tag_names }}" class="w-full px-2 py-3 rounded-xl border"
                autocomplete="off" placeholder="detail">
        </div>
